...
function LoginInputText({ text, setText, placeholder }) {
    const [isFocus, setIsFocus] = useState(false)
    return (
        <div
            className={`${text !== "" ? "pb-[2px] pt-[14px]" : "py-2"
                } w-full bg-gray-50 px-2 text-sm relative rounded-[4px] overflow-hidden border-[1px] my-1 ${isFocus === true ? "border-gray-400" : "border-gray-300"
                }`}
        >
            <span
                className={`${text !== ""
